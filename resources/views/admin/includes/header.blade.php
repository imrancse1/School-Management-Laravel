...
<!--User Avatar Start-->
<img class="avatar" src="@if (Auth::user()->avatar) {{asset('/').'/'.$user->avatar}} @endif" alt="Avatar">
<!--User Avatar Start-->
            ...
            <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                    ...
                    <li class="dropdown-submenu">
                        ...
                        <ul class="dropdown-menu">
                            @if(!isset($header))
                            <li><a href="{{route('add-header-footer')}}" class="dropdown-item">Add Header and Footer</a></li>
                            @endif
                            @if(isset($header))
                            <li><a href="{{route('manage-header-footer',['id'=>$header->id])}}" class="dropdown-item">Manage Header and Footer</a></li>
                            @endif
                        </ul>
                    </li>
                    ...
                    <li class="dropdown-submenu">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li><a href="{{route('userRegistration')}}" class="dropdown-item">Add User</a></li>
                            <li><a href="{{route('userList')}}" class="dropdown-item">Users List</a></li>
                            @endif
                            <li><a href="{{route('userProfile',['userId'=>Auth::user()->id])}}" class="dropdown-item">Users Profile</a></li>
                        </ul>
                    </li>
